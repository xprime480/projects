...
private:
  ...
  struct GNW
  {
    ...
    GraphNode const * operator*() const
    {
      return node;
    }
  private:
  ...
  public:
    ...
    typedef std::set< void * >       DataType;
    typedef DataType::iterator       IterType;
    typedef DataType::const_iterator ConstIterType;
	...
	throw "GraphNode: index out of range";
      ...
      ConstIterType p = nodes.begin();
      std::advance( p, n );
      return (GraphNode const *) *p;
    }
