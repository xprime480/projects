...
> moveStack4 :: Integer -> Peg -> Peg -> Peg -> Peg -> [Move]
> moveStack4 0 _ _ _ _            = []
> moveStack4 1 src _ _ dst        = moveSingle src dst
> moveStack4 n src h1 h2 dst      = moveStack4 (n-2) src h2 dst h1 ++ (moveSingle src h2) ++ (moveSingle src dst) ++ (moveSingle h2 dst) ++ (moveStack4 (n-2) h1 h2 src dst)

The final function has the same general form as the hanoi function.
 
> hanoi4 :: Integer -> Peg -> Peg -> Peg -> Peg -> [Move]
> hanoi4 n src h1 h2 dst = moveStack4 n src h1 h2 dst
